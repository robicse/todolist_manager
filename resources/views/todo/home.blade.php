...
@section('body')
    ...
    <div class="col-lg-6 col-lg-offset-3">
		...
		<ul class="list-group col-lg-4">
            @foreach($todos as $todo)
            <li class="list-group-item">
                <a href="{{'/todolist_manager/todo/'.$todo->id.'/edit'}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
				<form class="form-group pull-right" action="{{'/todolist_manager/todo/'.$todo->id}}" method="post">
					{{csrf_field()}}
					{{ method_field('DELETE')}}
